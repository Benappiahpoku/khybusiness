<!-- filepath: /Users/benjaminappiah-poku/Khy/-webApps/projects/naachiaa-website-v1/src/views/ProductsView.vue -->
<template>
      ...
      <div class="mb-12">
        ...
        <div class="flex flex-wrap justify-center gap-3 mb-8">
          <button v-for="category in categories" :key="category" @click="selectedCategory = category"
            class="px-6 py-3 rounded-lg font-medium transition-all duration-300 min-h-[48px]" :class="selectedCategory === category
          ...
          <div v-for="product in filteredProducts" :key="product.id"
            ...
            <div class="p-6">
              ...
              <div class="space-y-3">
                ...
                <!-- Get Quote Button -->
                <button @click="requestQuote(product)" :disabled="!product.inStock"
                ...
                <!-- WhatsApp Share -->
                <button @click="shareProduct(product)"
