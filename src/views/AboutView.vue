  ...
  <main class="min-h-screen p-4 max-w-4xl mx-auto">
    ...
    <div class="mb-8 flex justify-center">
      <div class="w-48 h-48 rounded-full overflow-hidden shadow-lg">
        <img v-if="!imageError" src="/src/assets/images/benjaminprofilepicOriginal.jpg" alt="Benjamin Appiah-Poku"
    ...
    <section class="space-y-6 text-center">
      ...
      <div class="space-y-4 text-lg text-gray-700">
        ...
        <p class="bg-white p-4 rounded-lg shadow-sm">
          He consults on hotel developments across Africa with a background in Management, Economics, Law, and Computer
          Science.
        </p>
