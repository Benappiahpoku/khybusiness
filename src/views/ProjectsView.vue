<!-- filepath: /Users/benjaminappiah-poku/Khy/-webApps/projects/naachiaa-website-v1/src/views/ProjectsView.vue -->
<template>
  <!-- ===== NAACHIAA ESTATES PROJECTS PAGE START ===== -->
  <!-- 
    Simplified projects showcase - mobile-first design for Ghana's construction market
    Follows Khy guidelines: WhatsApp integration, touch-optimized, offline-aware
  -->
  <main class="min-h-screen bg-gray-50">
    ...
    <section class="container mx-auto px-4 py-16 max-w-6xl">
      ...
      <div class="mb-12">
        ...
        <div class="flex flex-wrap justify-center gap-3 mb-8">
          <button v-for="category in projectCategories" :key="category.id" @click="selectedCategory = category.id"
      ...
      <div class="mb-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div v-for="project in filteredProjects" :key="project.id"
            ...
            @click="openProjectModal(project)" role="button" :aria-label="`View details for ${project.title}`"
            tabindex="0" @keydown.enter="openProjectModal(project)" @keydown.space="openProjectModal(project)">
            ...
            <div class="p-6">
              ...
              <div class="space-y-3">
                ...
                <div class="flex flex-wrap gap-1 mt-3">
                  <span v-for="product in project.productsUsed.slice(0, 2)" :key="product"
                    class="bg-gray-100 text-gray-700 px-2 py-1 rounded text-xs">
                    {{ product }}
                  </span>
                  <span v-if="project.productsUsed.length > 2"
      ...
      <div class="mb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <!-- Testimonial Card -->
          <div v-for="testimonial in clientTestimonials" :key="testimonial.id"
            ...
            <div class="flex items-center gap-1 mb-4">
              <svg v-for="star in 5" :key="star" class="w-5 h-5"
                :class="star <= testimonial.rating ? 'text-yellow-400' : 'text-gray-300'" fill="currentColor"
                viewBox="0 0 20 20">
                <path
    ...
    <!-- ===== OFFLINE INDICATOR ===== -->
    <div v-if="!isOnline" class="fixed bottom-4 left-4 right-4 bg-orange-500 text-white p-4 rounded-lg shadow-xl z-50"
