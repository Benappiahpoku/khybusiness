  ...
  <div v-if="showNotification"
    ...
    <div class="content flex items-center space-x-3">
      <div class="flex-shrink-0">
        ...
        <svg v-else-if="needRefresh" class="w-6 h-6 text-blue-500" fill="none" stroke="currentColor"
          viewBox="0 0 24 24">
      ...
      <div class="flex-1">
        <p v-if="offlineReady" class="text-sm font-medium text-gray-900 dark:text-gray-100">
          App ready to work offline
        </p>
        <p v-else-if="needRefresh" class="text-sm font-medium text-gray-900 dark:text-gray-100">
          New version available
        </p>
        <p v-else-if="needRefresh" class="text-sm text-gray-500 dark:text-gray-400">
    ...
    <div class="buttons flex space-x-3">
      <button v-if="needRefresh" @click="update"
...
// ===== Constants & Config =====
const OFFLINE_READY_KEY = 'khy-offline-ready-shown'
