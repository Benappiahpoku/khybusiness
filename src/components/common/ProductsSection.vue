<!-- filepath: /Users/benjaminappiah-poku/Khy/-webApps/projects/naachiaa-website-v1/src/components/common/ProductsSection.vue -->
<template>
  <!-- ===== NAACHIAA ESTATES PRODUCTS SECTION START ===== -->
  <!-- 
    Simplified products section - mobile-first design for Ghana's market
    Follows Khy guidelines: 48px touch targets, WhatsApp integration, offline-aware
  -->
    ...
    <div class="container mx-auto max-w-6xl">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        ...
        <div v-for="product in products" :key="product.id" @click="viewProduct(product)"
          ...
          :aria-label="`Learn more about ${product.name}`" tabindex="0" @keydown.enter="viewProduct(product)"
          @keydown.space="viewProduct(product)">

          <!-- ===== PRODUCT IMAGE PLACEHOLDER ===== -->
          <div
            class="relative h-48 bg-gradient-to-br from-blue-100 to-gray-100 rounded-t-xl flex items-center justify-center">
          ...
          <div class="p-6 flex-1 flex flex-col">
            ...
            <div class="space-y-2 mb-4">
              <div v-for="feature in product.keyFeatures" :key="feature"
            ...
            <div class="flex items-center text-blue-600 font-medium text-sm hover:text-blue-700 transition-colors">
              Learn More
              <svg class="w-4 h-4 ml-1 transform hover:translate-x-1 transition-transform" fill="none"
 ...
 * Following Khy guidelines: WhatsApp integration required
 */
const businessInfo = {
 ...
 * WhatsApp integration required by Khy guidelines
 */
