<!-- filepath: /Users/benjaminappiah-poku/Khy/-webApps/projects/naachiaa-website-v1/src/components/common/HeroSection.vue -->
<template>
  ...
  -->
  <section
    class="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 px-4 py-20">
 ...
 * Required by Khy guidelines for Ghana's intermittent connectivity
 */
