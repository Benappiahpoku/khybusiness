  ...
  <div class="error-layout flex flex-col" :class="rootClasses" role="document">
    ...
    <header class="bg-primary-600 shadow-sm py-4" role="banner">
      <div class="container mx-auto px-4">
        <router-link to="/" class="flex items-center gap-2 router-link" aria-label="Return to Khy homepage">
          <!-- <img 
          ...
          /> -->
          <KhyLogo white />
          <span class="text-lg font-semibold text-white">Khy</span>
        </router-link>
      </div>
    </header>
...
import KhyLogo from '@/components/base/KhyLogo.vue'
